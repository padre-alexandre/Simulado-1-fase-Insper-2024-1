...
base_matriz = pd.read_csv('Simulado Nacional - Jazz Vestibular - 2023.1 - Matriz de Questões.csv')
base_resultados = pd.read_csv('Simulado Nacional - Jazz Vestibular - 2023.1 - Resultado 1º fase.csv')
base_resultados_2fase = pd.read_csv('Simulado Nacional - Jazz Vestibular - 2023.1 - Resultado 2º fase.csv')
...
turma_cien = 'Simulado Nacional Insper - 2023.2 - Ciências de Computação'
...
resultados_gerais2_aux['Nota na questão'] = 1.25*resultados_gerais2_aux['Nota na questão']
...
if login_aluno != '':
    ...
    base_redacao = pd.read_csv(('Simulado Nacional - Jazz Vestibular - 2023.1 - Resultado Redação.csv'))
    ...
    with st.container():
            col1, col2, col3 = st.columns([6, 20, 4])
            with col1:
                st.write("")
            with col2:
